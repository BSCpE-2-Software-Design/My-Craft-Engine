...
TEST_CASE("Merge same ingredient") {
    ...
    chest.addIngredient(
        Ingredient("Wood", 2, "pcs")
    );

    chest.addIngredient(
        Ingredient("Wood", 3, "pcs")
    );
...
TEST_CASE("Universal tool works") {
    ...
    CHECK(
        chest.hasTool("Guardian Sigil", 3)
    );
}
...
TEST_CASE("Remove ingredients") {
    ...
    chest.addIngredient(
        Ingredient("Wood", 5, "pcs")
    );

    chest.removeIngredients({
        Ingredient("Wood", 2, "pcs")
        });
